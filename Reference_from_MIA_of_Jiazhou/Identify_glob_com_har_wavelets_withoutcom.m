function CommonHarWavelets=Identify_glob_com_har_wavelets_withoutcom(Graph,k,beta_1)
...
for S_i=1:SubjectNum
    ...
    %     u_vec=u_vector{N_i};
        ...
        err=1;       
        iter2=1;
        while err>0.00001&&iter2<1000 % 0.0000001
...
%             end
        ...
        CommonHarWavelets(N_i,S_i).Region_mask=u_vec;
        CommonHarWavelets(N_i,S_i).v=v;
        CommonHarWavelets(N_i,S_i).Harmonics=Phi_k;
    end
    fprintf('sub: %d\n',S_i);
end
end
