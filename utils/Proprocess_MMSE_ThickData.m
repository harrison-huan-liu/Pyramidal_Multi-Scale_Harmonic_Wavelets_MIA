function [AD_MMSE,SMC_MMSE,LMCI_MMSE,EMCI_MMSE,CN_MMSE,AD_data,SMC_data,LMCI_data,EMCI_data,CN_data] = Proprocess_MMSE_ThickData(MMSE_path,Thickness_path,Subject_path)
...
for i=1:size(PTID)
    ...
    mmse_vector=MMSE_RAW(strcmp(MMSE_RAW(:,3),Subject_PTID),15);
    disease=temp(I,6);
